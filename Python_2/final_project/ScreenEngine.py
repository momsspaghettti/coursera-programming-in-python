...
class GameSurface(ScreenHandle):
    ...
    def get_xy(self):
        ...
        if hero_pos[0] < center[0] or 2 * center[0] >= map_size[0]:
            x = 0
        elif hero_pos[0] < map_size[0] - center[0]:
            x = hero_pos[0] - center[0]
        else:
            x = map_size[0] - center[0] * 2

        if hero_pos[1] < center[1] or 2 * center[1] >= map_size[1]:
            y = 0
        elif hero_pos[1] < map_size[1] - center[1]:
            y = hero_pos[1] - center[1]
        else:
            y = map_size[1] - center[1] * 2
